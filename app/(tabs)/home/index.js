...
const index = () => {
  ...
  const suggestions = [
    {
      id: "0",
      todo: "Bebe agua, mantente sano",
    },
    {
      id: "1",
      todo: "Ir a hacer ejercicio",
    },
    {
      id: "2",
      todo: "Ir a la cama temprano",
    },
    {
      id: "3",
      todo: "Tomar recordatorio de pastillas",
    },
    {
      id: "4",
      todo: "Ir de compras",
  ...
  const addTodo = async () => {
    try {
      ...
      axios
        .post("http://192.168.0.25:3000/todos/666a6b44efdc85bde5c3da5e", todoData)
        .then((response) => {
  ...
  const getUserTodos = async () => {
    try {
      const response = await axios.get(
        `http://192.168.0.25:3000/users/666a6b44efdc85bde5c3da5e/todos`
      );
  ...
  const markTodoAsCompleted = async (todoId) => {
    try {
      ...
      const response = await axios.patch(
        `http://192.168.0.25:3000/todos/${todoId}/complete`
      );
  ...
  console.log("completado", completedTodos);
  console.log("pendiente", pendingTodos);
  return (
    <>
      <View
        style={{
      ...
      >
        ...
        >
          <Text style={{ color: "white", textAlign: "center" }}>Trabajar</Text>
        </Pressable>
        <Pressable
          style={{
            backgroundColor: "#7CB9E8",
        ...
        <View style={{ padding: 10 }}>
          {todos?.length > 0 ? (
            ...
            >
              ...
              >
                ¡No hay tareas para hoy! agregar una tarea
              </Text>
              <Pressable
